 ...
 * Template para mostrar productos marcados como novedad
 */
...
<body <?php body_class('page-novedades'); ?>>
    <?php wp_body_open(); ?>
    ...
    <main class="tienda-archive">
        ...
        <!-- 1. Intro (Título + Texto ACF de la página Novedades) -->
        ...
        <!-- 4. Grid de productos (con filtro de novedad) -->
